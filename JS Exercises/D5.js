...
const newCar = {
  ...
  model: "G 500",
  color: "black",
  trims: ["amg", "sport", "brabus"],
  licensePlate: "EP104DE",
};
...
for (let i = 0; i < newCars.length; i++) {
  justTrims.push(newCars[i].trims[0]);
}
...
const positionsArray = []; // Nuovo array per le posizioni
